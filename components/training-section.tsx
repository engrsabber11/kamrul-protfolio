...
const trainings: TrainingItem[] = [
  ...
  {
    title: "Bangladesh Labor Act-2006",
    topics: "Labor Act 2006",
    institute: "FMCG HR Society",
  },
  {
    title: "English Course",
    topics: "Corporate English Course",
    institute: "Goori Learning",
  },
  {
    title: "MS Office - Basic to Advance",
    topics: "MS Office (Basic to Advance)",
    institute: "Logic Prodigy",
  },
  {
    title: "Bangladesh Labor Act-2006 (Amendment 2022)",
    topics: "Labor Act 2006 Amendment 2022",
    institute: "BSHRM",
  },
  {
    title: "Workplace Success",
    topics: "RX for workplace success",
    institute: "Team Group",
  },
  {
    title: "Office Etiquette",
    topics: "Office etiquette essentials",
    institute: "Twelve Clothing Ltd.",
  },
  {
    title: "Strategic Human Resources",
    topics: "Strategic HR Planning",
    institute: "Team Group",
  },
  {
    title: "RACI Matrix",
    topics: "Role clarity via RACI",
    institute: "Twelve Clothing Ltd.",
  },
  {
    title: "Seven Habits",
    topics: "Seven Habits of effective people",
    institute: "Team Group",
  },
  {
    title: "Negotiation Skills",
    topics: "Negotiation frameworks",
    institute: "Twelve Clothing Ltd.",
  },
  {
    title: "Compensation & Benefits",
    topics: "Training on compensation & benefits",
    institute: "Smily",
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-screen-xl">
        ...
        >
          ...
          <p className="mt-3 max-w-3xl text-sm text-[#e6dbff] sm:text-base">
            A blend of strategic HR, compliance, productivity, and personal
            effectiveness programs—paired with active leadership in professional
            societies.
          </p>
        </div>
        ...
        <div className="space-y-8">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {trainings.map((training, idx) => (
                ...
                >
                  ...
                  <p className="mt-2 text-xs text-[#dcd3ff]">
                    {training.topics}
                  </p>
                  <div className="mt-3 inline-flex rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[11px] font-semibold">
                    {training.institute}
                  </div>
                </div>
              ))}
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div
              className={`rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur ${
                isInView ? "animate-fade-in-up animate-delay-120" : "opacity-0"
              }`}
            >
              <div className="flex items-center gap-2">
            ...
            >
              <p className="text-sm leading-relaxed text-[#e6dbff]">
                Emphasizing lifelong learning—mixing compliance, productivity,
                strategy, and communication to strengthen leadership and team
